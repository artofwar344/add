  ...
  export default {
    data() {
      return {
        ...
        errorNumInfo: '',
        popupVisible6: false,
        errMsg1: `您好！未查询到特种设备作业人员证件信息，无法办理此事项，请核实！如有疑问，请咨询相关部门。`,
        errMsg2: [`您好！经查询您的特种设备作业人员证件有效期至`, `，已过期失效，无法办理此事项，请核实！如有疑问，请咨询相关部门。`],
        errMsg3: `您好！经查询您有多个特种设备作业人员证，暂不支持线上办理，请前往发证机关办理。`,
        popData: {
          title: '无法办理此事项',
          text: '',
          btnList: [
    ...
    methods: {
      ...
      getData() {
        ...
        /*
                if (!/(^\d{15}$)|(^\d{18}$)|(^\d{17}()\d|X|x)$/.test(this.queryData.sfzh)) {
