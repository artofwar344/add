  ...
  <div class="settleForm">
    ...
    <div class="input_outside_box">
      <div class="input_box">
        ...
        <input type="text"  :value="relation ? relation.cmnCdNm : ''" placeholder="请选择关系类别" @click="open('pickerselect04')"/>
      </div>
      <div class="input_box">
        <span class="middlethree">*</span>
        <label>姓名</label>
      ...
      <div class="input_box">
        ...
        <label>性别</label>
        <Icon type="arrow-right" size="16" color="#999999"></Icon>
        <input type="text"  :value="sex ? sex.cmnCdNm : ''" placeholder="请选择性别" @click="open('pickerselect05')"/>
      </div>
      <div class="input_box">
        <span class="middlethree">*</span>
        <label>民族</label>
        <Icon type="arrow-right" size="16" color="#999999"></Icon>
        <input type="text"  :value="nation ? nation.cmnCdNm : ''" placeholder="请选择民族" @click="open('pickerselect06')"/>
      </div>
      <div class="input_box">
        <span class="middlethree">*</span>
        <label>出生日期</label>
      ...
      <div class="input_box">
        ...
        <label>血型</label>
        <Icon type="arrow-right" size="16" color="#999999"></Icon>
        <input type="text" placeholder="请选择血型" :value="blood ? blood.cmnCdNm : ''" @click="open('pickerselect09')"/>
      </div>
    </div>
...
<!-- 选择民族 -->
 ...
 ></Huiselect>
    ...
    <stuff-upload-modul :modelParams="moduleData" @backData="callBackHandle"
    ...
    export default {
      ...
      computed: {
        ...
        moduleData: function () {
         let data = [
            {
              title: '新生儿出生医学证明（原件）',
              fileNameKey: `${this.workId}_hz-01_02_abcd00004`
            },
            {
              title: '父亲、母亲的居民户口簿（原件）首页、户主页、本人页',
              fileNameKey: `${this.workId}_hz-01_02_abcd00006`
            },
            {
              title: '父亲、母亲的居民身份证（原件）',
              fileNameKey: `${this.workId}_hz-01_02_abcd00007`
            },
            {
              title: '生父母双方共同签署的陈述情况说明',
              fileNameKey: `${this.workId}_hz-01_02_abcd00008`
            },
            {
              title: '父母双方共同签署的申请书',
              fileNameKey: `${this.workId}_hz-01_02_abcd00003`
            },
            {
              title: '有资质的亲子鉴定部门出具的父子亲子鉴定证明',
              fileNameKey: `${this.workId}_hz-01_02_abcd00105`
            },
          ]
      ...
      methods:{
        ...
        validData (data) {
          ...
          if (Object.keys(data)[0] === 'formData' || Object.keys(data)[0] === 'subFormData') {
        ...
        saveAllData () {
          ...
          let formData = {formData: {
            ...
            lh_type: '02',   // 申请类型:01婚;02 非婚生随父落户;03非婚生随父落户
            mzdm: this.nation ? this.nation.cmnCd : '',
            sg: this.height,
            sqr_phone: window.sessionStorage.getItem("userphone") ? window.sessionStorage.getItem("userphone") : '11',
            sqr_sfz: window.sessionStorage.getItem("cardid") ? window.sessionStorage.getItem("cardid") : '111',
            sqr_xm: window.sessionStorage.getItem("username") ? window.sessionStorage.getItem("username") : '1111',
