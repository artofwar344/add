...
export default {
  ...
  methods: {
    ...
    pushAjax() {
      ...
      // this.conutycode = '089',
      // this.ownType = 'ckq';
      // this.calendar1.items.value = '2018-08-23';
      // this.calendar1.items.rangeValue = '2018-08-28';
      let setdata = {
        txnCommCom: {
          tRecInPage: "",
          tPageJump: "",
      ...
      console.log(setdata);
      this.$ajaxRequest("post", "/gsp/mng30037", setdata, pagejump)
        .then(res => {
