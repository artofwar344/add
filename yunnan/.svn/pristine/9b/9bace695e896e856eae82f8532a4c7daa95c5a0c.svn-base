<template>
          ...
          <div class="example-upload_formText">
            ...
            <div class="example-upload">
              ...
              <ccbUpload
                ...
                :upload-id=item.file_name @uploadRes='handleRes' app-id="GSP_APP_001" bucket-id="GSP_PRIVATE" pic-url-pre-fixed="/image-service/downloadImage?" :upload-index='index'>
    ...
    <div class="alertimg"><input type="checkbox" class="" value="01" v-model="yuedu">我已阅读并同意<span @click="showcns">《承诺书》</span>。</div>
    ...
    <div class='cns altbox' v-show='cns'>
      <div class='center cnsbox'>
        <h1>承诺书</h1>
        <div class="cnsboxcen">
          以上婚育情况，夫妻双方如有虚假或隐瞒，造成违法生育的，愿意按照《云南省人口与计划生育条例》相关规定接受处罚，并由夫妻双方共同承担相应的法律责任。
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      arr: [
        ...
        // { file_name: "壹孩户口簿个人页", uploadId: [], namekey: "onechldrsdncidvpg_" }
      ],
      arrs: [],
      flag: false,
      defaultList: [
  ...
  methods: {
    ...
    previewHandle(data, index) {//查看大图2
      this.isShow = true
