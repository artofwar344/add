      ...
      <van-row>
        <van-tabs v-if="this.$route.path=='/help/base'">
          <van-tab :title="BshowName">
            <!-- <van-col span="22" offset="2" class="inner">
              <div @click="goContentTab({base:1 })">1.我购买了课程，却不知如何收听？</div>
              <div  @click="goContentTab({base:1 })">
                <span class="iconlist">&rsaquo;</span>
              </div>
            </van-col>
            <van-col span="22" offset="2" class="inner">
              <div  class="tex"  @click="goContentTab( {base:2})"> 2.为什么手机打开中读APP，没有内容？</div>
              <div  @click="goContentTab({base:2 })">
                <span class="iconlist">&rsaquo;</span>
              </div>
            </van-col>
            <van-col span="22" offset="2" class="inner">
              <div  @click="goContentTab({base:3 })">3.为什么我的文稿不显示？</div>
        ...
        <van-tabs v-if="this.$route.path=='/help/account'">
          <van-tab :title="BshowName">
            ...
            <van-col span="22" offset="2" class="inner">
              <div  @click="goContentTab({account:1 })">1.为什么购买后“我的购买”是空的？</div>
              <div  @click="goContentTab({account:1 })">
                <span class="iconlist">&rsaquo;</span>
              </div>
            </van-col>
            <van-col span="22" offset="2" class="inner">
              <div  @click="goContentTab({account:2 })">2.我有两个中读账户怎么办？</div>
              <div   @click="goContentTab({account:2 })">
                <span class="iconlist">&rsaquo;</span>
              </div>
            </van-col>
            <van-col span="22" offset="2" class="inner">
              <div class="tex"  @click="goContentTab({account:3 })">3.同一个中读账户可以在两台手机上使用吗？</div>
        ...
        <van-tabs v-if="this.$route.path=='/help/interests'">
          <van-tab :title="BshowName">
            <van-col span="22" offset="2" class="inner">
              <div  class="tex"   @click="goContentTab({interests:1 })">1.请问VIP权益包括什么？</div>
              <div @click="goContentTab({interests:1 })">
                <span class="iconlist">&rsaquo;</span>
              </div>
            </van-col>
            <van-col span="22" offset="2" class="inner">
              <div @click="goContentTab({interests:2 })">2.请问VIP权益不包括什么？</div>
              <div @click="goContentTab({interests:2 })">
                <span class="iconlist">&rsaquo;</span>
              </div>
            </van-col>
            <van-col span="22" offset="2" class="inner">
              <div class="tex" @click="goContentTab({interests:3 })">3.请问我的VIP到期后，领取的杂志还能看吗？</div>
              <div @click="goContentTab({interests:3 })">
                <span class="iconlist">&rsaquo;</span>
              </div>
            </van-col>
            <van-col span="22" offset="2" class="inner">
              <div class="tex" @click="goContentTab({interests:4 })">4.请问年卡和月卡会员有区别吗？</div>
        ...
        <van-tabs v-if="this.$route.path=='/help/buy'">
          <van-tab :title="BshowName">
            <van-col span="22" offset="2" class="inner">
              <div  @click="goContentTab({buy:1 })">1.可以通过微信购买吗？</div>
              <div @click="goContentTab({buy:1 })">
                <span class="iconlist">&rsaquo;</span>
              </div>
            </van-col>
            <van-col span="22" offset="2" class="inner">
              <div @click="goContentTab({buy:2 })">2.为什么使用读币购买不成功？</div>
              <div @click="goContentTab({buy:2 })">
                <span class="iconlist">&rsaquo;</span>
              </div>
            </van-col>
            <van-col span="22" offset="2" class="inner">
              <div class="tex" @click="goContentTab({buy:3 })">3.为什么充值了读币，却没有到账？</div>
              <div @click="goContentTab({buy:3 })">
                <span class="iconlist">&rsaquo;</span>
              </div>
            </van-col>
            <van-col span="22" offset="2" class="inner">
              <div class="tex" @click="goContentTab({buy:4 })">4.请问可以开发票吗？</div>
        ...
        <van-tabs v-if="this.$route.path=='/help/version'">
          <van-tab :title="BshowName">
            <van-col span="22" offset="2" class="inner">
              <div  @click="goContentTab({version:1 })">1.音频支持下载吗？</div>
              <div   @click="goContentTab({version:1 })">
                <span class="iconlist">&rsaquo;</span>
              </div>
            </van-col>
            <van-col span="22" offset="2" class="inner">
              <div  @click="goContentTab({version:2 })">2.文稿可以打印吗？</div>
