            ...
            <van-col span="24">
                <div class="my-question-bg">
                    <div class="my-question-bg1">
                        <img src="../../pages/zhongduPay/img/code.jpg" class="my-question-img" alt="">
                ...
                <div v-if="isShowConfirm" class="my-confirm" @click.stop="clickFun('clickCancel')">
                    <div class="confirm-content-wrap" @click.stop>
                        ...
                        <div style="padding: 0 10px;position: relative;">
                            <img src="../../pages/zhongduPay/img/cardLogo.png" alt="" width="100%">
...
<script>
    export default {
        ...
        data() {
            return {
                isShowConfirm: true, // 用于控制整个窗口的显示/隐藏
