    ...
    <div>
        <div class="banner-bg">
            <van-row>
                ...
                <van-col span="24" class="note banner-img-bg" :style="note">
                    <img src="../../pages/zhongduPay/img/vip_card_bg@2x.png" alt="" width="100%">
                    <div class="banner-img-bg-content">
                        <img src="../../pages/zhongduPay/img/play_btn@3x.png" alt="" width="40px" height="40px">
        ...
        <van-row>
            <van-col span="24" class="user-card-auth">
                <div class="user-card-auth-title">
                    <img src="../../pages/zhongduPay/img/classify_01@2x.png" alt="" width="133">
                </div>
                ...
                <div class="user-card-auth-img">
                    <img src="../../pages/zhongduPay/img/group.png" alt="" width="100%">
                </div>
            </van-col>
        </van-row>
        <van-row>
            <van-col span="24" class="user-card-auth">
                <div class="user-card-auth-title">
                    <img src="../../pages/zhongduPay/img/classify_02@2x.png" alt="" width="133">
                </div>
                <div class="user-card-auth-content">
                    《三联生活周刊》封面故事每期推出一个封面大使，由各个领域有号召力和影响力，并和当期封面故事主题最为契合的明星大咖和知识领袖担任，十分钟讲解当期封面话题，并提出自己见解，分享自己的一段相关往事。让你在上下班路上、健身房内、饭桌上，和大咖“锵锵二人行”，既能快速吃透当期封面主题要点，又能获得更多跨界学识。
                </div>
                <div class="user-card-auth-img">
                    <img src="../../pages/zhongduPay/img/cover_book@2x.png" alt="" width="100%">
                </div>
            </van-col>
        </van-row>
        <van-row>
            <van-col span="24" class="user-card-auth">
                <div class="user-card-auth-title">
                    <img src="../../pages/zhongduPay/img/classify_03@2x.png" alt="" width="133">
                </div>
                <div class="user-card-auth-content">
                    《三联生活周刊》封面故事每期推出一个封面大使，由各个领域有号召力和影响力，并和当期封面故事主题最为契合的明星大咖和知识领袖担任，十分钟讲解当期封面话题，并提出自己见解，分享自己的一段相关往事。让你在上下班路上、健身房内、饭桌上，和大咖“锵锵二人行”，既能快速吃透当期封面主题要点，又能获得更多跨界学识。
                </div>
                <div class="user-card-auth-img">
                    <img src="../../pages/zhongduPay/img/small_class3.png" alt="" width="100%">
                </div>
            </van-col>
        </van-row>
        <van-row>
            <van-col span="24" class="user-card-auth">
                <div class="user-card-auth-title">
                    <img src="../../pages/zhongduPay/img/classify_04@2x.png" alt="" width="133">
                </div>
                <div class="user-card-auth-content">
                    《三联生活周刊》封面故事每期推出一个封面大使，由各个领域有号召力和影响力，并和当期封面故事主题最为契合的明星大咖和知识领袖担任，十分钟讲解当期封面话题，并提出自己见解，分享自己的一段相关往事。让你在上下班路上、健身房内、饭桌上，和大咖“锵锵二人行”，既能快速吃透当期封面主题要点，又能获得更多跨界学识。
                </div>
                <div class="user-card-auth-img">
                    <img src="../../pages/zhongduPay/img/small_class@2x.png" alt="" width="100%">
                </div>
            </van-col>
        </van-row>
        <van-row>
            <van-col span="24" class="user-card-auth">
                <div class="user-card-auth-title">
                    <img src="../../pages/zhongduPay/img/classify_05@2x.png" alt="" width="133">
                </div>
                <div class="user-card-auth-content">
                    《三联生活周刊》封面故事每期推出一个封面大使，由各个领域有号召力和影响力，并和当期封面故事主题最为契合的明星大咖和知识领袖担任，十分钟讲解当期封面话题，并提出自己见解，分享自己的一段相关往事。让你在上下班路上、健身房内、饭桌上，和大咖“锵锵二人行”，既能快速吃透当期封面主题要点，又能获得更多跨界学识。
                </div>
        ...
        <div class="footer-content">
            <van-row style="margin-top: .6rem;">
                ...
                <van-col span="12" type="danger">
                    <van-button type="danger"
                                style="width: 88%;background-color: #f2755c;border-color: #f2755c;font-size: 16px;" @click="Android()">
                        确认支付
                    </van-button>
                </van-col>
            </van-row>
            ...
            <div v-show="AndroidIsShow">
                <img src="../../pages/zhongduPay/img/Androidmask1.png" alt="" class="androidMask">
            </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                flag:1,
                note:{
                    backgroundImage:"url("+require("../../pages/zhongduPay/img/background_black@2x.png")+")",
        ...
        methods: {
            pageUrl(){
                this.$http.post('h5/ke/difftime.do?keId=44', {
                    baseURL:'http://mdev.lifeweek.com.cn/'
                })
                    .then(res => {
                        console.log(res);
                    })
            ...
            ios(){
                // window.location.href = 'https://zdimg.lifeweek.com.cn/'
