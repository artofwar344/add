<template>      
  ...
  <el-form label-width="100px" class="subjectStyle" v-model="contentedit" @submit.native.prevent>
    ...
    <el-form-item :label="contentedit.subjectDetails">
      <el-row v-if="this.$route.query.modeltype ==16">
    ...
    contentData() {
      this.$http
        .get("api/portal/model/modelContentList", {
          params: { pgNo: this.$route.query.page, rowNum: 10, modelId: this.$route.query.indexId }
        })
        .then(res => {
       ...
       switch (modeltype) {
        ...
        case 15: // 免费专区 
         this.modelnimg = { width: 106, height: 137 };
          break;  
        case 13: // 专题列表 
         this.modelnimg = { width: 750, height: 250 }; 
          break;
        case 12: // 听外刊 
