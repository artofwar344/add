	...
	<div class="bureau_sports_search">
        ...
        <div class="littlestarbig">
          <span class="littlestar">*</span>
				  <Field type="text" label="发票代码" :value="textValue" v-model="textValue" placeholder="请输入发票代码"></Field>
        </div>
        <div class="littlestarbig">
          <span class="littlestar">*</span>
					<Field type="text" label="发票号码" :value="number" v-model="number" placeholder="请输入发票号码"></Field>
        </div>
        <Field type="text" label="社会信用代码" :value="creditValue" v-model="creditValue" placeholder="请输入社会信用代码"></Field>
				<Field type="text" label="开票方纳税人识别号" :value="taxNumber" v-model="taxNumber" placeholder="请输入识别码"></Field>
        <div class="littlestarbig">
          <span class="littlestar">*</span>
        <Field type="text" label="验证码" :value="codeCheck" v-model="codeCheck" placeholder="请输入验证码">
          <RandomCode
					 slot="prepend"
					:codeCheck='codeCheck'
					@getCode='getCode'
