...
<template>
  <div class="check_wrap">
    ...
    <ul class="list">
      ...
      <li class="number">
        <Field
          :propserror="texterrorNote"
          :error="texterrorNoteInfo"
          type="number"
          label="标段编号"
          :value="textValue"
          placeholder="请输入标段编号"
      ...
      <li class="noteName">
        <Field
          :propserror="errorNote"
          :error="errorNoteInfo"
          type="text"
          label="公告名称"
          :value="comeReason"
          placeholder="请输入公告名称"
          v-on:currentval="handleNoteVal"
          v-on:errorchange="handleErrorChangesNote"
        ></Field>
      </li>
      <li class="time">
        <div class="li_wrap">
...
export default {
  ...
  methods: {
    ...
    submitEvent() {
      ...
      // // 测试数据
      // this.corporate_name = '梁河县';
      // this.citycode = '010';
      // this.conutycode = '072',
      // this.project_id = "E5308260000";
      // this.calendar1.items.value = '2018-11-10';
      // this.calendar1.items.rangeValue = '2018-11-17';
      let setdata = {
        txnCommCom: {
          tRecInPage: "",
          tPageJump: "",
