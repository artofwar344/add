    ...
    return {
      ...
      arr: [
        ...
        },
        {
          ...
          uploadId: [],
          namekey: "bghzc_bghzc_lwroffcatcl_"
        },
        {
          file_name: "合伙协议",
          content:
  ...
  methods: {
    ...
    submit_btn() {
      ...
      if (!this.arr[0].uploadId.length) {
        this.$toast("合伙人会议决议（必填项）");
        return;
      }
      if (!this.arr[1].uploadId.length) {
        this.$toast("律师事务所章程（必填项）");
        return;
      }
    ...
    clearData() {
      clear("rsn");
      clear("before_pro_abstract");
      clear("after_pro_abstract");
      function clear(str) {
...
.bghhxyxk_wrap .example-upload_btn {
  display: block;
  margin-top: 0.48rem;
  width: 1.6rem;
  height: 1.6rem;
...
.bghhxyxk_wrap .example-upload_formItem {
  font-size: 0.28rem;
  width: 90%;
...
.bghhxyxk_wrap .example-upload_formLabel {
  font-size: 0.28rem;
  font-weight: 700;
  margin-left: 0.1rem;
}
...
.bghhxyxk_wrap .hui-popupPrompt_btn-cancel {
  display: none;
}
.bghhxyxk_wrap .hui-popupPrompt_btn-confirm {
  width: 100%;
}
</style>
<style lang="less">
