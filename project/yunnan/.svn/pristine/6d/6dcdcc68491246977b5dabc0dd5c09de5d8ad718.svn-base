		...
		<div class="Top">
          ...
          <div class="littlestarbig">
            <span class="littlestar">*</span>
					  <Field :propserror="errorText" :error="errorTextInfo" desc-class="richText" type="text" label="拟加入执业机构名称" :value="textValue" placeholder="自动获取用户认证信息"  v-on:currentval="handleTextVal" v-on:errorchange="handleErrorChangesText">
					</Field>
          </div>
          <div class="littlestarbig">
            <span class="littlestar">*</span>
					  <Field :propserror="errorText" desc-class="richText" type="text" label="主管司法居住" :value="number" placeholder="用户手动输入" v-on:errorchange="handleErrorChangesText"  v-on:currentval="handleTextVal">
					</Field>
          </div>
          <div class="littlestarbig">
            <span class="littlestar">*</span>
					  <Field :propserror="errorText" desc-class="richText" type="text" label="执业经营" :value="carMsg" placeholder="" v-on:errorchange="handleErrorChangesText"  v-on:currentval="handleTextVal">
					</Field>
          </div>
