<template>
	<div class="index">
		...
		<div class="footer">
			...
			<Selectpopup ref="pickerselect01" @touchmove.prevent  position="bottom" :dataslots="selectData01" class="example-select_item" @confirms="selectConfirmFun01"></Selectpopup>
			...
			<div v-show="(map_eml===null)?false:true">
				...
				<Field :propserror="errorEmail" :error="errorEmailInfo" type="email" label="邮寄地址" :value="emailValue" placeholder="请选择邮寄地址" readonly  v-else='map_eml'>
				</Field>
			</div>
		</div>
