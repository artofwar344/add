...
let Utils = (function() {
	...
	/**
	 * 获得以“http://”开头的链接地址，并加上当前域的HOST名称,例如 g_utils.getHttpLink("/code/abcdefg")将返回"https://runjs.cn/code/abcdefg"
	 * @method getHttpLink
...
let Console = new ConsoleUtils(false);
