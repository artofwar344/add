...
export default {
  ...
  methods: {
    ...
    pushAjax() {
      ...
      // 测试数据
      // this.corporate_name = '云龙县';
      // this.citycode = '013';
      // this.conutycode = '090',
      // this.project_id = "YN00001309020171011000011932";
      // this.calendar1.items.value = '2017-10-10';
      ...
      this.$ajaxRequest("post", "/gsp/mng30025", setdata, pagejump)
        .then(res => {
