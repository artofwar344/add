  ...
  <div>
    ...
    <div class="examAdmission">
      <ul>
        ...
        <li><label>学籍号</label><span>{{datatext.xjh}}</span></li>
      </ul>
      <div class="graduateExam">
        <ul>
          <li><label>录取院校</label><span>{{datatext.xxmc}}</span></li>
          <li><label>录取专业</label><span>{{datatext.zymc}}</span></li>
          <li><label>招生类别</label><span>{{datatext.zslbmc}}</span></li>
          <li><label>批次名称</label><span>{{datatext.pcmc}}</span></li>
        </ul>
      </div>
    </div>
  </div>
...
@import url('../../../../assets/css/examAdmission.less');
</style>
