  ...
  computed: {
    ...
    moduleData: function() {
      let data = [
        {
          title: "新生儿出生医学证明（原件）",
          fileNameKey: `${this.workId}_hz-01_03_abcd00004`
        },
        {
          title: "母亲的居民户口簿（原件）首页、户主页、本人页",
          fileNameKey: `${this.workId}_hz-01_03_abcd00011`
        },
        {
          title: "母亲的申请书",
          fileNameKey: `${this.workId}_hz-01_03_abcd00009`
        },
        {
          title: "母亲的陈述情况说明",
          fileNameKey: `${this.workId}_hz-01_03_abcd00010`
        }
      ];
