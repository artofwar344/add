    ...
    <div class="gangAoFourWrap">
        ...
        <div class="content">
          ...
          <div class="middleone">
            ...
            <Field v-if="confirmApply.value && confirmApply.value == applyPicker[0].values[1].value" type="text" class="noborder" label="现持证件号码" :value="nowId" :model="nowId" placeholder="请输入您的现持证件号码">
            </Field>
          </div>
            <div class="inputList" v-if="confirmApply.value && (confirmApply.value == applyPicker[0].values[0].value || confirmApply.value == applyPicker[0].values[1].value)">
              ...
              <div class="middleone">
                <span class="middletwo">*</span>
                <Field readonly  label="有效次数" type="text" placeholder="请选择申请的有效次数" :value="selectGangNum" @click.native="open('gangNumPicker')">
                        <span slot="append" class="example-select_arrowRight"></span>
                </Field>
              </div>
                <Selectpopup
              ...
              <div class="middleone">
                <span class="middletwo">*</span>
                <Field readonly  label="有效次数" type="text" placeholder="请选择申请的有效次数" :value="selectAoNum" @click.native="open('aoNumPicker')">
                        <span slot="append" class="example-select_arrowRight"></span>
                </Field>
              </div>
                <Selectpopup
