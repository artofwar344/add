<template>
  <div class="app-container">
    ...
    <el-table :data="userData" stripe style="width: 100%;height: 100%;" v-if="contentPath" v-loading="CLoading">
      ...
      <el-table-column label="首页内容管理" width="380" >
        <template slot-scope="scope">
          ...
          <el-button
            ...
            size="small"
             :disabled="scope.row.shelvesState ==2" 
            type="danger"
         >删除</el-button> <!--   v-show="scope.row.modelTypeId ==14" -->
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    sortChange(val) {
      ...
      this.postArgument =
        "api/portal/model/" + this.$route.query.indexId + "/content/" +this.indexType;
    ...
    changeManagementName(val) {
     var ManagementTitle = val.title?val.title:''
      this.$prompt("改内容名", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
