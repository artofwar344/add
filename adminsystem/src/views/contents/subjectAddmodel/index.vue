  ...
  <div>
    <el-form label-width="100px" @submit.native.prevent>
      ...
      <el-form-item :label="subject.particular">
        ...
        <span style=" display: inline-block; float: right; font-size: 14px;  color:  #606266;">专题简介文字加符号限500个</span> 
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    managementSub() {
      ...
      console.log(subLength,'l++');
      
      let descriptionLength = subLength <= 500?true :false;
